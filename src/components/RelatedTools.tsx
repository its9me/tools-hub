...
const ALL_TOOLS_DATABASE: RelatedToolItem[] = [
  ...
  { id: 'xml-viewer', nameAr: 'مستعرض ومحلل ملفات XML التفاعلي المتقدم', nameEn: 'Interactive XML File Viewer & Parser', descAr: 'عرض وفحص وتنسيق ملفات XML التفاعلية محلياً بخصوصية تامة وتصديرها بصيغة JSON', descEn: 'Parse, inspect, format, validate, and convert XML tags to JSON structures offline', icon: Code2, category: 'developers', colorClass: 'border-cyan-500/20 text-cyan-400 group-hover:border-cyan-500/50' },
